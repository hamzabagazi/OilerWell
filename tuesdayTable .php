...
<html lang="en">
 <head>
      <title>Tuesday Appointments</title>
  ...
  <article>
        <div class="container">
		  <h2> Tuesday Appointments</h2>  
	       <table id ="Tuesday-Appointments" class ="table table-bordered" >
                   <thead>
 <tr>
  <th>Id</th> 
  <th>First</th> 
...
//print users records in table
  ...
  $sql = "SELECT  firstName, lastName, dateTime, blood FROM users WHERE dateTime LIKE '%11-06%' ORDER BY dateTime  ASC";
...
?>
      ...
      <script>
      $('#Tuesday-Appointments').tableExport();
      </script>
    </article>
	<footer>

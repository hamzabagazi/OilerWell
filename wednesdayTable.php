...
<html lang="en">
 <head>
      <title>Wednesday Appointments</title>
  ...
  <article>
        <div class="container">
		  <h2> Wednesday Appointments</h2>  
	       <table id ="Wednesday-Appointments" class ="table table-bordered" >
                   <thead>
 <tr>
  <th>Id</th> 
  <th>First</th> 
 ...
 <?php
  ...
  $sql = "SELECT  firstName, lastName, dateTime, blood FROM users WHERE dateTime LIKE '%11-07%' ORDER BY dateTime  ASC";
...
?>
      ...
      <script>
      $('#Wednesday-Appointments').tableExport();
      </script>
    </article>
	<footer>
